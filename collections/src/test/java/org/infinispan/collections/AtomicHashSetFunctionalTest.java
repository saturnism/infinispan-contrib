...
@Test(groups = "functional", testName = "atomic.AtomicHashSetFunctionalTest")
public class AtomicHashSetFunctionalTest extends AbstractInfinispanTest {
   private static final Log log = LogFactory.getLog(AtomicHashSetFunctionalTest.class);
   ...
   public void testChangesOnAtomicMap() {
      ...
      assert collectionsManager.getAtomicHashSet(cache, "set").contains("Hello");
   }
