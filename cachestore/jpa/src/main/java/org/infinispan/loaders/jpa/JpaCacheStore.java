...
public class JpaCacheStore extends LockSupportCacheStore<Integer> {
	...
	public void start() throws CacheLoaderException {
		...
		EntityManagerFactoryRegistry emfRegistry = EntityManagerFactoryRegistry.getInstance();
		
		try {
			this.emf = emfRegistry.getEntityManagerFactory(config
	...
	public void stop() throws CacheLoaderException {
		try {
			...
			EntityManagerFactoryRegistry emfRegistry = EntityManagerFactoryRegistry.getInstance();
			emfRegistry.closeEntityManagerFactory(config.getPersistenceUnitName());
